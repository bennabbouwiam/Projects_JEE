...
@Service
@Transactional //les opérations sont transactionelles dans la couche service
@AllArgsConstructor //pour injection dependencies
@Slf4j
public class BankAccountServiceImpl implements  BankAccountService{

    //repositories and injection dependencies
    //@Autowired
    ...
    //un système de journalisation pour logger des messages (framework : log4j / api: slf4j)
    //create objet aveclequel on peut logger des msgs dans l'app
    //Logger log = LoggerFactory.getLogger(this.getClass().getName());



    //injections dependencies with constructor
    /*
...
*/
    ...
    @Override
    public SavingBankAccountDTO saveSavingBankAccount(double initialBalance, double interestRest, Long customerId) throws CustomerNotFoundException {
        Customer customer= customerRepository.findById(customerId).orElse(null);
        if(customer==null)
            throw new CustomerNotFoundException("Customer not found");
        ...
        savingAccount.setInterestRate(interestRest);
